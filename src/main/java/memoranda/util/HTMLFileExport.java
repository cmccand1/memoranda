/**
 * HTMLFileExport.java Created on 25.02.2003, 17:59:14 Alex Package: net.sf.memoranda.util
 *
...
public class HTMLFileExport {
   ...
   */
  public HTMLFileExport(File f, Document doc, Note note, String charset, boolean num,
      String templFile, boolean xhtml) {
    this.f = f;
