/**
 * NoteListImpl.java Created on 21.02.2003, 15:43:26 Alex Package: net.sf.memoranda
 *
...
//    public static final String NS_JNNL = "http://www.openmechanics.org/2003/jnotes-noteslist";
  ...
  /*
   * @see net.sf.memoranda.types.NoteList#removeNoteForDate(net.sf.memoranda.date.CalendarDate)
   */
