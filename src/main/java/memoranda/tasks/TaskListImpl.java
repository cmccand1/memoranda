/**
 * TaskListImpl.java Created on 21.02.2003, 12:29:54 Alex Package: net.sf.memoranda
 *
...
public class TaskListImpl implements TaskList {
  ...
  /**
   * @see net.sf.memoranda.TaskList#removeTask(import net.sf.memoranda.types.Task)
   */
