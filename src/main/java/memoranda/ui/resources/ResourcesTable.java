package memoranda.ui.resources;
...
public class ResourcesTable extends JTable {
  ...
  ImageIcon inetIcon = new ImageIcon(
      memoranda.ui.AppFrame.class.getResource("/ui/icons/mimetypes/inetshortcut.png"));
  ...
  public TableCellRenderer getCellRenderer(int row, int column) {
    return new javax.swing.table.DefaultTableCellRenderer() {
      ...
      public Component getTableCellRendererComponent(
        ...
        comp = (JLabel) super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row,
            column);
        if (column == 0) {
