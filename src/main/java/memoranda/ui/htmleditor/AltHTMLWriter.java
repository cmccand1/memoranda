/**
 * AltHTMLWriter.java Hacked version of javax.swing.text.html.HTMLWriter Created on 18.02.2003,
 * 16:27:05 Alex Package: javax.swing.text.html
 *
    ...
    public AttributeSet getArea(int x, int y, int width, int height) {
      ...
      if (numAttributes > 0) {
        ...
        for (int counter = 0; counter < numAttributes; counter++) {
          if (counter >= numAreas) {
            areas.addElement(
                createRegionContainment((AttributeSet) areaAttributes.elementAt(counter)));
          }
