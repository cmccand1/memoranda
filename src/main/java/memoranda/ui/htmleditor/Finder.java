/**
 * Finder.java Created on 18.03.2003, 13:57:20 Alex Package: net.sf.memoranda.ui.htmleditor
 *
 * @author Alex V. Alishevskikh, alex@openmechanics.net Copyright (c) 2003 OpenMechanics.org
 */
...
import memoranda.ui.miscDialogs.ContinueSearchDialog;
import memoranda.ui.miscDialogs.ReplaceOptionsDialog;
...
public class Finder extends Thread {
  ...
  public void findAll() {
    ...
    while (matcher.find(start)) {
      ...
      if (_replace != null) {
        if (!replaceAll) {
          ReplaceOptionsDialog dlg = new ReplaceOptionsDialog(
              Local.getString("Replace this occurence?"));
