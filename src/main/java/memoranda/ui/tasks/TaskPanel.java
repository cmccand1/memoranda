...
public class TaskPanel extends JPanel {
  ...
  void jbInit() throws Exception {
    ...
    subTaskB.setIcon(
        new ImageIcon(
            memoranda.ui.AppFrame.class.getResource("/ui/icons/todo_new_sub.png")));
...
//        editTaskB.setEnabled(true);
    editTaskB.setIcon(
        new ImageIcon(
            memoranda.ui.AppFrame.class.getResource("/ui/icons/todo_edit.png")));
    ...
    removeTaskB.setIcon(
        new ImageIcon(
            memoranda.ui.AppFrame.class.getResource("/ui/icons/todo_remove.png")));
    ...
    completeTaskB.setIcon(
        new ImageIcon(
            memoranda.ui.AppFrame.class.getResource("/ui/icons/todo_complete.png")));
    ...
    */
    ...
    CurrentDate.addDateListener(new DateListener() {
      public void dateChange(CalendarDate d) {
        newTaskB.setEnabled(
            d.inPeriod(CurrentProject.get().getStartDate(), CurrentProject.get().getEndDate()));
      }
    });
    ...
    taskTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
      public void valueChanged(ListSelectionEvent e) {
        ...
        ppCalcTask.setEnabled(
            enbl); // default value to be over-written later depending on whether it has sub tasks
        ...
        if (enbl) {
          ...
          parentPanel.calendar.calendarTable.renderer.setTask(t);
          parentPanel.calendar.calendarTable.updateUI();
        } else {
          parentPanel.calendar.calendarTable.renderer.setTask(null);
          parentPanel.calendar.calendarTable.updateUI();
        }
      }
    });
...
//        CalendarDate ed = new CalendarDate((Date) dlg.endDate.getModel().getValue());
    ...
    Task newTask = CurrentProject.getTaskList()
        .createTask(sd, ed, dlg.todoField.getText(), dlg.priorityCB.getSelectedIndex(), effort,
...
//      //taskTable.updateUI();
  ...
  void removeTaskB_actionPerformed(ActionEvent e) {
    ...
    for (int i = 0; i < taskTable.getSelectedRows().length; i++) {
      Task t =
          CurrentProject.getTaskList().getTask(
              taskTable.getModel().getValueAt(taskTable.getSelectedRows()[i], TaskTable.TASK_ID)
                  .toString());
      if (t != null) {
        toremove.add(t);
      }
