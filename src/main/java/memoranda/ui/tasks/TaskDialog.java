...
//        border7 = BorderFactory.createLineBorder(Color.white, 2);
    ...
    header.setIcon(new ImageIcon(TaskDialog.class.getResource(
        "/ui/icons/task48.png")));
    ...
    descriptionField.setPreferredSize(new Dimension(375,
        387)); // 3 additional pixels from 384 so that the last line is not cut off
    ...
    startDate.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent e) {
        ...
        SpinnerDateModel sdm = new SpinnerDateModel((Date) startDate.getModel().getValue(), null,
            null, Calendar.DAY_OF_WEEK);
    ...
    endDate.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent e) {
        // it's an ugly hack so that the spinner can increase day by day
        SpinnerDateModel sdm = new SpinnerDateModel((Date) endDate.getModel().getValue(), null,
            null, Calendar.DAY_OF_WEEK);
  ...
  void setNotifB_actionPerformed(ActionEvent e) {
    ((AppFrame) App.getMainAppFrame()).workPanel.dailyItemsPanel.eventsPanel.newEventB_actionPerformed(e,
