...
public class AddResourceDialog extends JDialog {
  ...
  /**
   * set CANCELLED variable to false so we can know the user pressed the ok buton and close this
   * dialog.
   */
  ...
  /**
   * enable localRB fields. Request focus for the text field so the user can start typing and set
   * the pathField text selected
   */
  ...
  /**
   * enable inetShorcutRB fields. Request focus for the text field so the user can start typing and
   * set the urlField text selected
   */
