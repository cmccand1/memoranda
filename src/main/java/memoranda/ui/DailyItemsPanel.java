...
import memoranda.events.EventNotificationListener;
import memoranda.events.EventsScheduler;
import memoranda.history.History;
import memoranda.history.HistoryItem;
import memoranda.history.HistoryListener;
...
import memoranda.ui.events.EventsPanel;
import memoranda.ui.tasks.TaskPanel;
...
public class DailyItemsPanel extends JPanel {
  ...
  ImageIcon expIcon = new ImageIcon(
      memoranda.ui.AppFrame.class.getResource("/ui/icons/exp_right.png"));
  ImageIcon collIcon = new ImageIcon(
      memoranda.ui.AppFrame.class.getResource("/ui/icons/exp_left.png"));
  ImageIcon bookmarkIcon = new ImageIcon(
      memoranda.ui.AppFrame.class.getResource("/ui/icons/star8.png"));
  ...
  void jbInit() throws Exception {
    ...
    alarmB.setIcon(
        new ImageIcon(memoranda.ui.AppFrame.class.getResource("/ui/icons/alarm.png")));
    ...
    taskB.setIcon(
        new ImageIcon(memoranda.ui.AppFrame.class.getResource("/ui/icons/task.png")));
...
//                // DEBUG
    ...
    EventsScheduler.addListener(new EventNotificationListener() {
      public void eventIsOccured(memoranda.events.Event ev) {
        /*DEBUG*/
    ...
    if (date.equals(CalendarDate.today())) {
      ...
      if (EventsScheduler.isEventScheduled()) {
                ...
                for (Iterator it = EventsScheduler.getScheduledEvents().iterator(); it.hasNext();) {
                    net.sf.memoranda.types.Event ev = (net.sf.memoranda.types.Event)it.next();   
                    evlist += ev.getTimeString()+" - "+ev.getText()+"\n";
                } */
        memoranda.events.Event ev = EventsScheduler.getFirstScheduledEvent();
