...
public class JTreeTable extends JTable {
   ...
   * in the component hieachy it will never receive this unless we forward it in this manner.
   */
  ...
  public class TreeTableCellEditor extends AbstractCellEditor implements
     ...
     * false, all keyboard actions are implemented in terms of the table. By returning true, the
     * tree would get a chance to do something with the keyboard events. For the most part this is
     * ok. But for certain keys, such as left/right, the tree will expand/collapse where as the
     * table focus should really move to a different column. Page up/down should also be implemented
     * in terms of the table. By returning false this also has the added benefit that clicking
     * outside of the bounds of the tree node, but still in the tree column will select the row,
  ...
  public class ListToTreeSelectionModelWrapper extends DefaultTreeSelectionModel {
    ...
    /**
     * Class responsible for calling updateSelectedPathsFromSelectedRows when the selection of the
     * list changse.
     */
