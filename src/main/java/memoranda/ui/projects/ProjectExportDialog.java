...
public class ProjectExportDialog extends JDialog {
  ...
  public JComboBox encCB = new JComboBox(new String[]{Local.getString("System default"), "UTF-8", "ANSI"});
  JLabel jLabel1 = new JLabel();
  GridLayout gridLayout1 = new GridLayout();
  public JCheckBox splitChB = new JCheckBox();
  public JCheckBox titlesAsHeadersChB = new JCheckBox();
