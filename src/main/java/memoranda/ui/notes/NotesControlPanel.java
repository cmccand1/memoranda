...
public class NotesControlPanel extends JPanel {
  ...
  void jbInit() throws Exception {
    ...
    ppAddBkmrk.setIcon(
        new ImageIcon(
            memoranda.ui.AppFrame.class.getResource("/ui/icons/addbookmark.png")));
    ...
    ppClearNote.setIcon(
        new ImageIcon(
            memoranda.ui.AppFrame.class.getResource("/ui/icons/editdelete.png")));
    ...
    ppRemoveBkmrk.setIcon(
        new ImageIcon(
            memoranda.ui.AppFrame.class.getResource("/ui/icons/removebookmark.png")));
