package memoranda.ui.miscDialogs;
...
import memoranda.ui.htmleditor.Util;
...
public class TdDialog extends JDialog {
  ...
  void jbInit() throws Exception {
    ...
    header.setIcon(new ImageIcon(ImageDialog.class.getResource(
    ...
    bgColorB.setIcon(new ImageIcon(ImageDialog.class.getResource(
        "/htmleditor/icons/color.png")));
