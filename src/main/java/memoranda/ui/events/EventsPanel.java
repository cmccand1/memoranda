...
public class EventsPanel extends JPanel {
  ...
  void jbInit() throws Exception {
    ...
    newEventB.setIcon(
        new ImageIcon(
            memoranda.ui.AppFrame.class.getResource("/ui/icons/event_new.png")));
    ...
    editEventB.setIcon(
        new ImageIcon(
            memoranda.ui.AppFrame.class.getResource("/ui/icons/event_edit.png")));
    ...
    removeEventB.setIcon(
        new ImageIcon(
            memoranda.ui.AppFrame.class.getResource("/ui/icons/event_remove.png")));
  ...
  void removeEventB_actionPerformed(ActionEvent e) {
    ...
    if (eventsTable.getSelectedRows().length > 1) {
      ...
      ev = (memoranda.events.Event) eventsTable.getModel().getValueAt(
          eventsTable.getSelectedRow(),
          EventsTable.EVENT);
